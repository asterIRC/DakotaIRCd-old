...
const char *libratbox_platform = "Linux 3620networks 3.2.0-4-amd64 #1 SMP Debian 3.2.51-1 x86_64 GNU/Linux";
const char *libratbox_serno = SERIALNUM;
const char *libratbox_creation = "Fri Jan 10 2014 at 13:33:37 CST";
